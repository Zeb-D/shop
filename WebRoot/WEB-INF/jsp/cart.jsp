...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span24">
			<div class="step step1">
				...
				<div class="total">
					...
					书籍金额: <strong id="effectivePrice">￥<s:property value="#session.cart.total"/>元</strong>
				</div>
				<div class="bottom">
		...
		<s:else>
			<div class="span24">
				<div class="step step1">
					<span><h2>亲!您还没有购书!请先去购书!</h2></span>
				</div>
			</div>
		</s:else>
	</div>
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2016-2017 网上书店 版权所有</div>
	</div>
</div>
</body></html>